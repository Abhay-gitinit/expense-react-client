...
function CreateGroupModel({ show, onHide }) {
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className={errors.description ? 'form-control is-invalid' : 'from-control'} name="description" value={formData.description} onChange={onChange} />
                                {errors.description && (
                        ...
                        <div className="modal-footer border-0">
                            ...
                            <button type="submit" className=" btn btn-primary mx-4 rounded-pill" onClick={onHide}>
                                Add
                            </button>
                        </div>
                    </form>
